  ...
  data: [
    {
      ...
      skills: [
        ...
        "⚡ Building RESTful APIs in Python with Django REST Framework",
        "⚡ Building RESTful APIs in PHP with Laravel Framework",
        "⚡ Building RESTful APIs in JavaScript with Express.js",
        "⚡ Designing, building & managing WordPress Websites for my clients",
      ],
      softwareSkills: [
        {
          skillName: "HTML-5",
    ...
    },
    {
      ...
      skills: [
        "⚡ Experience of working with Docker containers, Nginx service & PostgreSQL Databases",
    ...
    },
    {
      ...
      skills: [
        "⚡ Learning to develop Smart Contract using Solidity",
        "⚡ Learning about Ethereum Blockchain Development",
        "⚡ Learning & practicing about Coins transactions using Metamask",
      ],
      softwareSkills: [
        {
          skillName: "Ethereum",
...
export const seoData = {
  title: "Fernando Joost | IT Engineer 🦾",
